...
<section class="recent-blog l-_hpx">
    <div class="container-fluid">
        <div class="wrapper">
            <div class="header_content text-center">
                <h1 class="header_text">Recent Blogs</h1>
            ...
            <div class="row">
                <div class="col-xl-7 col-lg-6 col-md-6 col-12">
                    <div class=" blog_card d-flex align-items-end text-white position-relative">
                        ...
                        <div class="content position-relative z-2">
                            ...
                            <h3 class="h-tag fw-bold h-4">Forem Ipsum Dolor Sit Amet Consectetur Adipiscing Elit</h3>
                ...
                <div class="col-xl-5 col-lg-6 col-md-6 col-12">
                    <div class=" blog_card d-flex align-items-end text-white position-relative">
                        <div class="image">
                            <img src="<?php echo $asset_path; ?>/assets/images/blogs/recent-blog2.jpg"
